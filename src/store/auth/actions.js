...
export default {
  async register({ commit }, userData) {
    try {
      const response = await axios.post(`https://blogspacejovana.000webhostapp.com/register.php`, userData);
  ...
  async fetchUsers({ commit }) {
    const response = await fetch(`https://blogspacejovana.000webhostapp.com/getUsers.php`);
